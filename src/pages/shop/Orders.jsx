        ...
        <aside className="orders-ticket">
          ...
          {lines.length > 0 && (
            <div style={{ padding: '16px 20px', borderTop: '1px solid #E5E7EB' }}>
              ...
              <button 
                type="button" 
                style={{ width: '100%', marginTop: 10, background: 'transparent', border: '1px solid #E5E7EB', color: '#6B7280', padding: '10px', borderRadius: 12, fontWeight: 600, fontSize: 12, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}
