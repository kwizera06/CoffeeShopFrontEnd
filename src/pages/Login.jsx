...
export default function Login() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      const landingRole = res.isOwner || res.role === 'SHOP_ADMIN' ? 'SHOP_ADMIN' : res.role === 'MANAGER' ? 'MANAGER' : res.role === 'AUDITOR' ? 'AUDITOR' : res.role
  ...
  async function onSupabaseSignIn(e) {
    ...
    try {
      ...
      const landingRole = me.isOwner || me.role === 'SHOP_ADMIN' ? 'SHOP_ADMIN' : me.role === 'MANAGER' ? 'MANAGER' : me.role === 'AUDITOR' ? 'AUDITOR' : me.role
      navigateByRole(nav, landingRole)
    } catch (err) {
