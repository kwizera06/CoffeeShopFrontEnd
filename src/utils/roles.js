...
export function isStorekeeperRole(role) {
...
export function getDashboardLabel(role) {
  ...
  if (isStorekeeperRole(role)) return 'Storekeeper'
...
export function staffRoleStyle(role) {
  ...
  if (role === 'STOREKEEPER') return { bg: 'rgba(234, 179, 8, 0.1)',  color: '#92400E', border: '#EAB30844' }
